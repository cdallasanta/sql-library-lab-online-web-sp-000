...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series INNER JOIN characters ON series.id = characters.series_id GROUP BY characters.species ORDER BY COUNT(characters.species) WHERE characters.species = 'Human';"
end
